...
{
	public class DAYTRIPBOOKINGHISTORYMap : EntityTypeConfiguration<DAYTRIPBOOKINGHISTORY>
	{
		public DAYTRIPBOOKINGHISTORYMap()
		{
			HasKey(t => t.id);
			Property(t => t.Description).HasMaxLength(50);
			Property(t => t.CancellationReason).HasMaxLength(500);
			ToTable("DAYTRIPBOOKINGHISTORY");
			...
			HasOptional(t => t.DAYTRIPBOOKING).WithMany(t => t.DAYTRIPBOOKINGHISTORies).HasForeignKey(d => d.BookingId);
		}
	}
}