  ...
  const handleInputChange = (field, value) => {
    if (field.includes('.')) {
      ...
      setFormData(prev => {
        ...
        // Auto-update slug when title changes, unless slug was manually edited
        if (field === 'title') {
          const currentSlug = prev.seo?.slug || '';
          const autoGeneratedSlug = generateSlug(prev.title || '');

          // Only auto-update if current slug matches the auto-generated one from the old title
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (!formData.title || !formData.description || !formData.price || !formData.location?.city) {
        showAlert('Please fill in all required fields (Title, Description, Price, City)', 'error');
        setSaving(false);
        return;
      }
              ...
              <Grid container spacing={2}>
                <Grid size={{ xs: 12, md: 6 }}>
                  <TextField
                    ...
                    required
                    helperText="Tour title (displayed on frontend)"
                  />
                </Grid>
                <Grid size={{ xs: 12, md: 6 }}>
                  <TextField
                    ...
                    helperText="Auto-generated from title, but can be manually edited"
                    InputProps={{
                      startAdornment: <Typography variant="body2" color="text.secondary" sx={{ mr: 1 }}>/tours/</Typography>,
                    }}
                  />
                </Grid>
                <Grid size={{ xs: 12, md: 6 }}>
