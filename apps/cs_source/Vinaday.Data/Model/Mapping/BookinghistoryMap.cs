...
{
	public class BookinghistoryMap : EntityTypeConfiguration<BOOKINGHISTORY>
	{
		public BookinghistoryMap()
		{
			HasKey(t => t.id);
			...
			HasOptional(t => t.BOOKING).WithMany(t => t.BookingHistories).HasForeignKey(d => d.BookingId);
		}
	}
}